...
class SteadyTopTimer:
    def __init__(self, duration_minutes=10, server_url=None):
        ...
        self.update_ui()
        self.tick()
        if server_url: self.poll_server() 
        self.root.mainloop()
    ...
    def poll_server(self):
        try:
            # Note: This still blocks the UI for up to 0.5s if the server is slow
...
if __name__ == "__main__":
    ...
    SteadyTopTimer(duration_minutes=args.duration_minutes, server_url=args.server_url)
